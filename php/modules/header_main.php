<header class="sticky">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container">
                <a class="navbar-brand" href="/index.php"><img class="brand_elem" src="/img/logo1.svg" alt="logo"></a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <i class="fa fa-lg fa-bars" aria-hidden="true"></i>
                </button>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav page me-auto mb-2 mb-lg-0 menu_header">
                        <li class="nav-item">
                    ...
                    <ul class="navbar-nav ms-auto top-menu mb-2 my-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="/pages/favor.php"><img class="icons" src="/img/solar_heart-broken.svg" alt="heart"></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="/pages/cart.php"><img class="icons1" src="/img/solar_bag-broken.svg" alt="bag"></a>
                        </li>
                        <?php if($_COOKIE['id'] == ''): ?>
                        <li class="nav-item">
                            <a class="nav-link" data-mdb-ripple-init data-mdb-modal-init data-mdb-target="#staticBackdrop" aria-current="page" href="#"><img class="icons2" src="/img/solar_user-broken.svg" alt="user"></a>
                        </li>
                        <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="/pages/account.php"><img class="icons2" src="/img/solar_user-broken.svg" alt="user"></a>
                        </li>
                        <?php endif; ?>
                    </ul>
                </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        >
            <!-- content2 auth -->
            <form class="auth_form my-3 row" action="/php/actions/auth.php" method="POST">
