...
<body>
    ...
    <main class="catalog_block">
        ...
        <section class="container">
            ...
            ?>
            <form class="redact_paste d-flex flex-column justify-content-center align-items-center white_content rounded-3 py-3" action="/php/actions/redaction.php" method="POST">
                    <p class="text-center">id</p>
                    <input class="mb-3" type="number" value="<?=$card['id']?>" readonly name="id">
                    <p class="text-center">Наименование</p>
                    <input class="mb-3" type="text" name="name" value="<?=$card['name']?>">
                    <p class="text-center">Описание</p>
                    <input class="mb-3" type="text" name="description" value="<?=$card['description']?>">
                    <p class="text-center">Цена</p>
                    <input class="mb-3" type="number" name="price" value="<?=$card['price']?>">
                    <p class="text-center">Изображение</p>
                    <input class="mb-3" type="text" name="img" value="<?=$card['img']?>">
                    <p class="text-center">Категория</p>
                    <input class="mb-3" type="number" name="category" value="<?=$card['category']?>">
